...
(declare-fun var8 () (_ BitVec 48))
(declare-fun var10 () (_ BitVec 48))
(declare-fun var12 () (_ BitVec 48))
(declare-fun var14 () (_ BitVec 48))
(declare-fun var16 () (_ BitVec 48))
(declare-fun var20 () (_ BitVec 48))
(declare-fun var28 () (_ BitVec 48))
...
(assert (= var8 (concat (_ bv0 32) var4)))
(assert (= var10 (concat (_ bv0 32) var3)))
(assert (= var12 (concat (_ bv0 32) var2)))
